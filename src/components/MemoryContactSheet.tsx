    ...
    <section className="relative py-28 px-6 bg-[#090806] overflow-hidden border-t border-brand-paper/10">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-12 lg:gap-20 items-center">
        <div className="space-y-8">
          <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-brand-amber/70">
          ...
          <p className="font-sans text-brand-gray leading-relaxed text-base md:text-lg max-w-xl">
            Digital photos are easy to make and easier to forget. Film creates a
            little friction, and that friction gives the moment value before you
            even see the result.
          </p>
            ...
            {frames.map((frame, index) => (
              <button
                ...
                className={`relative aspect-[4/5] overflow-hidden rounded-sm border transition-all duration-500 ${
                  active === index
                    ? "border-brand-paper scale-[1.02]"
                    : "border-brand-paper/15 opacity-60 hover:opacity-100"
                }`}
        ...
        <div className="film-frame min-h-[520px]">
          ...
          <div className="absolute left-10 right-10 bottom-10 z-30 max-w-xl">
            ...
            <h3 className="font-serif text-4xl md:text-6xl text-brand-paper mb-5">
              {selected.title}
            </h3>
            <p className="font-sans text-brand-paper/75 leading-relaxed text-base md:text-lg">
              {selected.body}
            </p>
          </div>
        </div>
