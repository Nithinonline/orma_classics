    ...
    <footer className="bg-brand-black border-t border-brand-accent pt-20 pb-10 px-6 relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-20">
        <div className="col-span-1 md:col-span-2 flex flex-col justify-between">
          <div>
            <h3 className="font-serif text-2xl text-brand-white mb-6 tracking-wide">
              ORMA CLASSICS
            </h3>
            <p className="font-sans text-brand-gray text-sm md:w-3/4 leading-relaxed">
              Collecting forgotten cameras, restoring them with care, and
              passing them forward for people who understand their value.
            </p>
          </div>
        </div>

        <div className="flex flex-col gap-4">
          <h4 className="font-sans text-[10px] tracking-widest uppercase text-brand-gray/50 mb-4">
            Nav
          </h4>
          <Link
            href="/story"
