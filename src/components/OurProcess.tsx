                        ...
                        <div className="absolute inset-x-8 bottom-8 z-30 grid grid-cols-2 gap-3">
                            {processSteps.map((step, index) => (
                                <button
                                    ...
                                    className={`relative border border-brand-paper/18 rounded-sm overflow-hidden min-h-[100px] bg-black/30 transition-all duration-300 ${currentImageIndex === index ? 'border-brand-amber/70 bg-black/60' : 'hover:border-brand-paper/30'}`}
                                >
                                    <Image
                                        src={step.image}
                                        alt={step.label}
                                    ...
                                    <div className="relative z-10 p-4">
                                        <span className="font-serif text-2xl text-brand-amber/70">0{index + 1}</span>
                                        <p className="font-sans text-[11px] uppercase tracking-[0.22em] text-brand-paper/80 mt-2">{step.label}</p>
                                    </div>
                                </button>
                            ))}
                        </div>
