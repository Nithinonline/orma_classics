        ...
        <section className="py-28 md:py-40 px-6 bg-[#070604] relative border-t border-brand-paper/10">
            ...
            <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-7 relative z-10">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <span className="font-sans text-[12px] tracking-[0.4em] uppercase text-brand-amber/80">Ready to Create</span>
                    <div className="w-8 h-[1px] bg-brand-amber/40" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-2">
                    <a href="#collection" className="inline-flex justify-center bg-brand-paper text-brand-black font-sans uppercase tracking-[0.2em] text-[10px] px-10 py-5 hover:bg-brand-amber hover:text-brand-paper transition-all duration-500 rounded-sm min-w-[220px]">
                        Browse Collection
                    </a>
