      ...
      <div className="relative z-10 min-h-screen-safe max-w-7xl mx-auto px-6 pt-36 pb-16 flex items-end">
        <Reveal eager className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#process"
              className="inline-flex justify-center bg-brand-paper text-brand-black font-sans uppercase tracking-[0.18em] text-xs px-8 py-5 hover:bg-brand-amber hover:text-brand-paper transition-colors duration-500 rounded-sm"
            >
              See Our Process
            </a>
            <a
              href="#collection"
              className="inline-flex justify-center border border-brand-paper/30 text-brand-paper font-sans uppercase tracking-[0.18em] text-xs px-8 py-5 hover:bg-brand-paper hover:text-brand-black transition-all duration-500 rounded-sm"
            >
              Browse Cameras
            </a>
          </div>
