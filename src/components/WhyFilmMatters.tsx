...
export default function WhyFilmMatters() {
  return (
    <section
      id="archive"
      className="relative py-32 px-6 bg-brand-black border-t border-brand-accent/50"
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-20 items-center">
          ...
          <div className="space-y-12 text-brand-gray font-sans leading-relaxed">
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base pl-8 text-brand-gray/80">
                Film makes you pause. It asks you to wait, observe, and choose
                your moment.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base pl-8 text-brand-gray/80">
                Grain, light leaks, soft focus - these aren&apos;t flaws.
                They&apos;re what make each photo human.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base pl-8 text-brand-gray/80">
                Not just stored somewhere, but something you can hold, revisit,
                and pass on.
              </p>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 relative space-y-4 md:space-y-0 md:h-[600px]">
          ...
          <div className="hidden md:flex absolute bottom-20 left-0 w-32 h-32 bg-brand-accent/50 border border-brand-white/10 items-center justify-center backdrop-blur-md z-20">
            <span className="text-brand-gray/50 text-[10px] tracking-widest uppercase text-center">
              Film
              <br />
              Artifact
            </span>
