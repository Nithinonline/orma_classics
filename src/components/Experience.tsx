export default function Experience() {
    const points = [
        { title: "You slow down.", desc: "The physical limit of 36 frames makes every shutter press a conscious decision." },
        { title: "You think.", desc: "Considering light, shadows, and composition before the moment passes." },
        { title: "You wait.", desc: "The delay between capture and result is part of the magic." }
    ];
        ...
        <section className="py-32 px-6 bg-brand-black/95 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                <div className="mb-24 flex flex-col items-center gap-6">
                    <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-brand-gray/40">The Experience</span>
                ...
                <div className="max-w-3xl mx-auto space-y-16 text-brand-gray font-sans leading-relaxed text-lg md:text-xl">
                    <p>
                        When you shoot on film, something changes.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12">
                         {points.map((p, i) => (
                             <div key={i} className="flex flex-col gap-4 items-center">
                                 <h3 className="text-brand-white font-serif italic text-xl">{p.title}</h3>
                                 <p className="text-xs tracking-widest leading-loose uppercase text-brand-gray/60">{p.desc}</p>
                             </div>
                         ))}
                    </div>
                    ...
                    <p className="pt-12 text-brand-white/90">
                        ...
                        <span className="text-3xl md:text-5xl font-serif mt-4 block">it feels earned.</span>
                    </p>
                </div>
            </div>
        </section>
